...
<body>
<form id="calendario"><table border="0" cellpadding="5" cellspacing="0" bgcolor="#D4D0C8">
  <tr>
    <td width="100%">
<?php
$fecha = getdate(time());
...
?>
    <select size="1" name="mes" class="m1" onchange="document.location = '?dia=<?php echo($dia);?>&mes=' + document.forms.insertar.mes.value + '&ano=<?php echo($ano);?>';">
<?php
...
?>
    </select>&nbsp;&nbsp;&nbsp;<select size="1" name="ano" class="m1" onchange="document.location = '?dia=<?php echo($dia); ?>&mes=<?php echo($mes);?>&ano=' + document.forms.insertar.ano.value;">
<?php
